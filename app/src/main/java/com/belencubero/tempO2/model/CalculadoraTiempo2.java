...
public class CalculadoraTiempo2 {

    // Cálculo del tiempo total (minutos) en función de la botella y el flujo.
    public static BigDecimal calcularTiempo(Botella2 botella, BigDecimal flujo) {
    ...
    public static String formatearTiempo(Botella2 botella, BigDecimal flujo) {
