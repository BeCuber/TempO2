...
public class CylinderTest {
    ...
    public void testCrearBotellaPrMenorPo() {
        Cylinder cylinder = new Cylinder(new Pressure(new BigDecimal("100"), UnitPressure.BAR), new BigDecimal("10"));
        Pressure pressure = new Pressure(new BigDecimal("150"), UnitPressure.BAR);
        cylinder.setPr(pressure);
    }
