...
public class CalculadoraTiempoTest3_2 {
    ...
    public CalculadoraTiempoTest3_2(BigDecimal volumen, int flujo, String tiempoEsperado) {
    ...
    public void testFormatoTiempoParametrizado() {
        ...
        Presion2 presion = new Presion2(new BigDecimal(2100), UnidadPresion2.PSI);

        // Crear la Botella2 con el volumen correspondiente
        Botella2 botella = new Botella2(presion, volumen);
